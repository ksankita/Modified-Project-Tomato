...
def create_dataset(data_dir="/content/project-tomato/PlantVillage-Tomato"):
...
def deleteUnusedData(extractDir="/content/project-tomato/PlantVillage-Tomato/Plant_leave_diseases_dataset_without_augmentation"):
    # Managing files
...
def scanOldDataset(dataDir="/content/PlantVillage-Tomato"):
...
def arrangeDataset(rawDataDir="/content/PlantVillage-Tomato/Plant_leave_diseases_dataset_without_augmentation", newDataDir="/content/project-tomato/PlantVillage-Tomato"):
    trainFiles = "/content/project-tomato/splits/train.txt"
    validFiles = "/content/project-tomato/splits/valid.txt"
    testFiles = "/content/project-tomato/splits/test.txt"
...
def deleteUnwanteFiles():
    ...
    try:
        shutil.rmtree("/content/project-tomato/PlantVillage-Tomato/Plant_leave_diseases_dataset_without_augmentation")
